...
import 'package:online_study/features/onboarding/onboarding_screen/screen/native_language.dart';
import 'package:online_study/theme/theme_change_controller.dart';

class LearnLanguage extends StatelessWidget {
  LearnLanguage({super.key});
                ...
                itemBuilder: (context, index) {
                  ...
                  return Obx(
                    () => _LanguageTile(
                      ...
                      flagAsset: flag,
                      isSelected:
                          controller.selectedLearnLanguage.value == language,
