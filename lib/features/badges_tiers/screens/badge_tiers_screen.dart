  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return GridView.builder(
        ...
        itemCount: controller.badgeTiersList.length,
        itemBuilder: (context, index) {
          final badge = controller.badgeTiersList[index];
          ...
          return TierCard(
            ...
            onTap: () {
              if (badge.unlocked == true) {
                Get.to(() => TierDetailsScreen(tierName: badge.title ?? ""));
              } else {
                _showLockedDialog();
              }
            },
